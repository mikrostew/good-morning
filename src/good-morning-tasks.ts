...
export interface KillProcessTask {
  name: string;
...
export interface VoltaPackageTask {
...
export interface ExecAndSaveTask {
...
// update a repository
export interface RepoUpdateTask {
  name: string;
...
export interface MachineMatchConfig {
  [key: string]: RegExp;
}
